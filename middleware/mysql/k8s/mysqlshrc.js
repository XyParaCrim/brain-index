...
function init() {
  if (options.cluster == null) {
    ...
    if (options.cluster == null) {
      options.cluster = dba.createCluster(options.clusterName, { groupSeeds: options.groupSeeds.map(localAddress).join(","), localAddress: address(options.defaultMaster, options.localPort)  })
